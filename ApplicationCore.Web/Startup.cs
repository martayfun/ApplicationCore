...
namespace ApplicationCore.Web
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationCoreContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("ApplicationCore.Web")));
