using ApplicationCore.DataLayer.Attributes;
...
namespace ApplicationCore.DataLayer.UnitOfWork
{
    ...
    {
        private readonly ApplicationCoreContext _dbContext;

        private IDbContextTransaction _tran;
        private readonly IServiceProvider _services;

        public SqlUnitOfWork(ApplicationCoreContext pDbContext, IServiceProvider services)
        {
